...
<div class="article-banner">
    ...
    <div class="banner-info">
        ...
        <div class="banner-rit">
            <p>
                <a href="http://localhost:8602/course/preview/learning.html?id=${model.courseInfoDto.id}" target="_blank">
                    <#if model.courseInfoDto.pic??>
                        <img src="http://file.localhost:8602${model.courseInfoDto.pic}" alt="" width="270" height="156">
                    <#else>
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        <#list firstNode.teachPlanTreeNodes as secondNode>
                                            <li><a href="http://localhost:8602/course/preview/learning.html?id=${model.courseInfoDto.id}&chapter=${(secondNode.teachplanMedia.teachplanId)!''}" target="_blank">${secondNode.pname}</a></li>
                                        </#list>
                                    </ul>
                                </div>
                            </div>
